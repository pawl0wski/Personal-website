...
const pl: LangI = {
    ...
    /* Welcome */
    welcomeTitle: "Cześć, tutaj",
    welcomeContinuationProfession: "Junior Software Developer",
    welcomeContinuationProfessionLocalization: "w ecom.software",
    ...
    projectWebsite: "Strona projektu",
    description: "Opis",
    ...
    /* Others */
    carrier: "Kariera",
    indexDescription: "Hej, jestem Jakub Pawłowski.",
};
